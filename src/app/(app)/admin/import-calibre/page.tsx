  ...
  return (
    <div className="space-y-8">
      <div className="admin-import-hero-enter space-y-2">
        <h2 className="eleven-display-section text-foreground text-3xl">Import Calibre</h2>
        <p className="text-eleven-secondary eleven-body-airy max-w-2xl text-base leading-relaxed">
          ...
          <span className="text-foreground font-mono text-sm">metadata.db</span> et un chemin racine
          monté côté serveur.
        </p>
      </div>
      <ImportCalibreClient />
