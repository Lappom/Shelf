export default function SearchLoading() {
  return (
    <div className="mx-auto w-full max-w-5xl px-6 py-8">
      ...
      <div className="mb-4 h-4 w-28 animate-pulse rounded bg-muted/80 motion-reduce:animate-none" />
      <div className="grid gap-3 sm:grid-cols-2">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="flex gap-3 rounded-xl border border-(--eleven-border-subtle) p-3"
          >
