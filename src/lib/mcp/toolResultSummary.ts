 ...
 */
export function summarizeMcpToolOutput(
  toolName: string,
  out: McpToolResult,
  ...
  try {
    ...
    if (data && typeof data === "object" && !Array.isArray(data)) {
      ...
      if (Array.isArray(o.results))
        return { resultKind: "list", toolName, count: o.results.length };
      if (Array.isArray(o.books)) return { resultKind: "books", toolName, count: o.books.length };
      if (Array.isArray(o.shelves))
        return { resultKind: "shelves", toolName, count: o.shelves.length };
      if (Array.isArray(o.annotations))
        return { resultKind: "annotations", toolName, count: o.annotations.length };
      ...
      if (Array.isArray(o.operations))
        return { resultKind: "batch_ops", toolName, count: o.operations.length };
